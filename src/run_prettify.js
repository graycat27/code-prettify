/**
 * @license
 * Copyright (C) 2022 yui Kitamura
 * *original* Copyright (C) 2013 Google Inc.
 *
...
(function () {
  ...
  var prettyPrint = (function () {
    ...
    (function () {
       ...
       * @const
       */
      var PR_STRING = PR_PREFIX + 'str';
      /**
       * token style for a keyword
       * @const
       */
      var PR_KEYWORD = PR_PREFIX + 'kwd';
      /**
       * token style for a comment
       * @const
       */
      var PR_COMMENT = PR_PREFIX + 'com';
      /**
       * token style for a type
       * @const
       */
      var PR_TYPE = PR_PREFIX + 'typ';
      /**
       * token style for a literal value.  e.g. 1, null, true.
       * @const
       */
      var PR_LITERAL = PR_PREFIX + 'lit';
      /**
       * token style for a punctuation string.
       * @const
       */
      var PR_PUNCTUATION = PR_PREFIX + 'pun';
      /**
       * token style for plain text.
       * @const
       */
      var PR_PLAIN = PR_PREFIX + 'pln';

      /**
       * token style for an sgml tag.
       * @const
       */
      var PR_TAG = PR_PREFIX + 'tag';
      /**
       * token style for a markup declaration such as a DOCTYPE.
       * @const
       */
      var PR_DECLARATION = PR_PREFIX + 'dec';
      /**
       * token style for embedded source.
       * @const
       */
      var PR_SOURCE = PR_PREFIX + 'src';
      /**
       * token style for an sgml attribute name.
       * @const
       */
      var PR_ATTRIB_NAME = PR_PREFIX + 'atn';
      /**
       * token style for an sgml attribute value.
       * @const
       */
      var PR_ATTRIB_VALUE = PR_PREFIX + 'atv';
       ...
       * @const
       */
      var PR_NOCODE = PR_PREFIX + 'nocode';
